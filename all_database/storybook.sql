...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1268474329ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=storybook&table=audiobooks">`storybook`.`audiobooks`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=storybook&table=podcasts">`storybook`.`podcasts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=storybook&table=books">`storybook`.`books`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=storybook&table=users">`storybook`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=agro_system&table=posts">`agro_system`.`posts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=residential_area&table=paying_guest">`residential_area`.`paying_guest`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=residential_area&table=guest_comment">`residential_area`.`guest_comment`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=residential_area&table=users">`residential_area`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=residential_area&table=rent_comment">`residential_area`.`rent_comment`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=residential_area&table=rent_house_post">`residential_area`.`rent_house_post`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="65435c4b6b243d734d70385e4b4e5a3f">
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="storybook" targettable="users">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="storybook" targettable="books">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `books`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="storybook" targettable="podcasts">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `podcasts`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="storybook" targettable="audiobooks">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `audiobooks`</span>
                        </div>
